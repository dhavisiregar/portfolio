...
export const HERO_CONTENT = {
  id: `Saya seorang Backend Developer yang fokus membangun sistem yang scalable, berperforma tinggi, dan arsitektur backend yang bersih. Di peran saya saat ini, saya membangun dan memelihara CMS LMS internal CBNCloud yang terintegrasi dengan SSO Cloudia CRM, serta menghadirkan dan menyesuaikan solusi CMS FilamentPHP untuk klien di berbagai industri perbankan, hospitality, dan platform LMS eksternal. Saya juga berkontribusi pada Cloudia CRM, CMS Website CBNCloud, dan Budget Controller (mini-ERP), serta mendiagnosis dan menyelesaikan gangguan produksi pada Sistem Notifikasi Sertifikat SSL milik CBNCloud sebelum memindahkan deployment-nya ke pipeline GitOps (ArgoCD/OKD) dengan pengamanan CI yang lebih ketat. Saya senang menulis kode yang efisien, menyelesaikan masalah kompleks, dan terus meningkatkan performa sistem.`,
  en: `I’m a Backend Developer focused on building scalable, high-performance systems and clean backend architectures. At my current role, I’ve built and maintained CBNCloud’s internal LMS CMS with Cloudia CRM SSO integration, and delivered and customized FilamentPHP CMS solutions for clients across banking, hospitality, and external LMS platforms. I’ve also contributed to the Cloudia CRM, CBNCloud Website CMS, and Budget Controller (mini-ERP), and diagnosed and resolved a production outage in CBNCloud’s SSL Certificate Notification System before re-platforming its deployment onto a GitOps (ArgoCD/OKD) pipeline with hardened CI safeguards. I’m passionate about writing efficient code, solving complex problems, and continuously improving system performance.`,
};

export const ABOUT_TEXT = {
  id: `Backend Developer dengan pengalaman kuat dalam membangun, memelihara, dan mengoptimalkan aplikasi server-side yang scalable dan aman menggunakan PHP, Laravel, dan Go. Punya rekam jejak menghadirkan dan menyesuaikan platform CMS FilamentPHP di berbagai domain perbankan, hospitality, dan LMS — termasuk CMS LMS internal CBNCloud dengan integrasi SSO Cloudia CRM, Cloudia CRM dan CMS Website CBNCloud, serta Budget Controller (mini-ERP). Berpengalaman mendiagnosis dan menyelesaikan insiden produksi, seperti memindahkan deployment Sistem Notifikasi Sertifikat SSL CBNCloud ke pipeline GitOps (ArgoCD/OKD) dengan pengamanan CI yang lebih ketat. Juga mendukung klien enterprise eksternal seperti SPPI (LSP) — menjaga dan mengembangkan platform CMS mereka, menangani laporan masalah, dan membantu penghantaran upgrade sistem Fase 2.`,
  en: `Backend Developer with strong experience building, maintaining, and optimizing scalable and secure server-side applications using PHP, Laravel, and Go. Proven track record delivering and customizing FilamentPHP CMS platforms across banking, hospitality, and LMS domains — including CBNCloud’s internal LMS CMS with Cloudia CRM SSO integration, the Cloudia CRM and CBNCloud Website CMS, and the Budget Controller mini-ERP. Experienced in diagnosing and resolving production incidents, such as re-platforming CBNCloud’s SSL Certificate Notification System onto a GitOps (ArgoCD/OKD) pipeline with hardened CI safeguards. Also supports external enterprise clients like SPPI (LSP) — maintaining and evolving their CMS platforms, triaging reported issues, and helping deliver Phase 2 system upgrades.`,
};
